...
public class ExtentTestNGIReporterListener implements IReporter {
    // 生成的路径以及文件名
    private static final String OUTPUT_FOLDER = "result/test-report/";
    private static final String FILE_NAME = "ExtentReports.html";
        ...
        if (tests.size() > 0) {
            ...
            for (ITestResult result : treeSet) {
                ...
                for(String output:outputList){
                    // 将用例的log输出报告中
                    test.debug(output.replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll("#a","<").replaceAll("a#",">"));
                }
